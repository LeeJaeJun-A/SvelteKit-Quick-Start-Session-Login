<script>
  ...
  export let mainClass = "bg-gray-50";
  export let mainDivClass =
    "flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0";
  export let h1Class =
    "mb-3 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl";
...
<main class={mainClass}>
  <div class={mainDivClass}>
    ...
    <div class={div2Class}>
      ...
      <P
        class="mb-5 text-base font-normal text-gray-500 md:text-lg"
      >
        {description}
      </P>
      <Button href={btnHref}>
